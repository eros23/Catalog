...
if($row2['radminsuper'] == 1 || $auth_user == 1) {
    ...
    switch ($op) {
        default:
            ...
            catalog_main($daynum);
            break;
        case $name_prefix . '_pagelist':
            require_once ('public/pagelist.php');
            catalog_pagelist();
            break;
        case $name_prefix . '_pageadd':
            require_once ('public/pageadd.php');
            catalog_pageadd($ok);
            break;
        case $name_prefix . '_pageedit':
            require_once ('public/pageedit.php');
            catalog_pageedit($id_catalog, $ok);
            break;
        case $name_prefix . '_pagedel':
            require_once ('public/pagedel.php');
            catalog_pagedel($id_catalog, $ok);
            break;
        case $name_prefix . '_pagedouble':
            require_once ('public/pagedouble.php');
            catalog_pagedouble($id_catalog, $ok);
            break;
    }
} else {
    include ("header.php");
